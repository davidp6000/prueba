 ...
 *
 * @version 2.1
 * @author David Paz <davidpazsua@hotmail.com>
 *
 * @param int[] $carrito    Array con los índices de los elementos del carrito
 * @param int $pedido       Id del pedido
 * @param string $correo    Texto del correo a enviar
 *
 * @return string
 * @see enviar_correo_multiples()
 */
function enviar_correos($carrito, $pedido, $correo)
{
    ...
    return enviar_correo_multiples(
        "$correo, $correo_Departamento_Pedidos",
        $cuerpo,
